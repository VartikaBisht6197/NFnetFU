...
```{r}
# Load Dataset 2
Data_Set_1 <- read.csv("NFnetFU_Dataset2_OTU_abundance(top 100).csv")
# Choose Microbiome Data
df_data1 <- Data_Set_1[2:101]
data1 <- data.matrix(df_data1)
# Create labels for prediction
meta_data <- read.csv("NFnetFU_Dataset2_metadata.csv")
...
#OTU to Microbes
OTU_file <- read.table("NFnetFU_Dataset2_taxanomy.csv", header = 1)
