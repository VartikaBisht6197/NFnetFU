...
label_dat <- as.numeric(factor(meta$dx))
...
#OTU to Microbes
OTU_file <- read.table("/Users/Vartika_Bisht/NFnetFU/Data/NFnetFU_Dataset2_taxanomy.csv", header = 1)
